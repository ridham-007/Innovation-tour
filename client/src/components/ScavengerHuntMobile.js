...
`;
  ...
  const onSubmit = async () => {
    ...
    setLoading(true);
    const newUser = { ...user, scavengerHunt: { ...user?.scavengerHunt, ...scavengerData } }
  ...
  return (
    <div
      ...
      style={{ height: "calc(100vh - 105px)", marginTop:"50px"}}
    >
      ...
      <div className="scavengerDetails">
        ...
        <div className="scavengerCenterSection">
          <h2 style={{fontSize:'30px', marginBottom:'10px'}} onClick={handleDialogOpen}>- REGISTER -</h2>
        </div>
